...
{
    [Fact]
    public void PostApPayment_Should_Create_ApControl_And_Bank_Entries_For_Full_Payment_Amount()
    {
        ...
        result.GlEntries.ShouldContain(x => x.AccountNo == "2000" && x.Debit == 150m);
        result.GlEntries.ShouldContain(x => x.AccountNo == "1000" && x.Credit == 150m);
