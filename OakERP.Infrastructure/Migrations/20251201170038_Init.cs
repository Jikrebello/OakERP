    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:inventory_transaction_type", "receipt,issue,adjustment,transfer_in,transfer_out,sales_cogs")
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_currency_decimals_range", "\"decimals\" BETWEEN 0 AND 4");
                    table.CheckConstraint("ck_currency_numeric_range", "\"numeric_code\" BETWEEN 1 AND 999");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    credit_hold_reason = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_customer_code_not_blank", "btrim(\"customer_code\") <> ''");
                    table.CheckConstraint("ck_customer_creditlimit_nonneg", "\"credit_limit\" IS NULL OR \"credit_limit\" >= 0");
                    table.CheckConstraint("ck_customer_email_basic_shape", "\"email\" IS NULL OR (position('@' in \"email\") > 1 AND position('.' in \"email\") > 3)");
                    table.CheckConstraint("ck_customer_hold_until_future", "\"credit_hold_until\" IS NULL OR \"credit_hold_until\" >= CURRENT_DATE");
                    table.CheckConstraint("ck_customer_name_not_blank", "btrim(\"name\") <> ''");
                    table.CheckConstraint("ck_customer_termsdays_range", "\"terms_days\" BETWEEN 0 AND 180");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_fiscper_periodno_range", "\"period_no\" BETWEEN 1 AND 12");
                    table.CheckConstraint("ck_fiscper_start_le_end", "\"period_start\" <= \"period_end\"");
                    table.CheckConstraint("ck_fiscper_status_allowed", "\"status\" IN ('open','closed')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    parent_account = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_glacct_no_chars", "\"account_no\" ~ '^[A-Z0-9][A-Z0-9\\.-]{0,19}$'");
                    table.CheckConstraint("ck_glacct_no_not_blank", "btrim(\"account_no\") <> ''");
                    table.CheckConstraint("ck_glacct_no_upper", "\"account_no\" = upper(\"account_no\")");
                    table.CheckConstraint("ck_glacct_parent_not_self", "\"parent_account\" IS NULL OR \"parent_account\" <> \"account_no\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'"),
                    updated_by = table.Column<string>(type: "text", nullable: true),
                    rate_fraction = table.Column<decimal>(type: "numeric(9,6)", nullable: false, computedColumnSql: "(\"rate_percent\" / 100.0)", stored: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_tax_rates", x => x.id);
                    table.CheckConstraint("ck_taxrate_dates", "\"effective_to\" IS NULL OR \"effective_to\" >= \"effective_from\"");
                    table.CheckConstraint("ck_taxrate_name_not_blank", "btrim(\"name\") <> ''");
                    table.CheckConstraint("ck_taxrate_pct_range", "\"rate_percent\" >= 0 AND \"rate_percent\" <= 100");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    vendor_code = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    phone = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    email = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    address = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_vendor_code_not_blank", "btrim(\"vendor_code\") <> ''");
                    table.CheckConstraint("ck_vendor_email_basic_shape", "\"email\" IS NULL OR (position('@' in \"email\") > 1 AND position('.' in \"email\") > 3)");
                    table.CheckConstraint("ck_vendor_name_not_blank", "btrim(\"name\") <> ''");
                    table.CheckConstraint("ck_vendor_termsdays_range", "\"terms_days\" BETWEEN 0 AND 180");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    doc_no = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ...
                    ship_to = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_arinvoice_currency_len3", "char_length(\"currency_code\") = 3");
                    table.CheckConstraint("ck_arinvoice_due_after_invoice", "\"due_date\" >= \"invoice_date\"");
                    table.CheckConstraint("ck_arinvoice_posted_requires_postingdate", "(\"doc_status\" <> 'posted'::doc_status) OR (\"posting_date\" IS NOT NULL)");
                    table.CheckConstraint("ck_arinvoice_totals_nonnegative", "(\"tax_total\" >= 0) AND (\"doc_total\" >= 0)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    journal_no = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_gljournal_no_not_blank", "btrim(\"journal_no\") <> ''");
                    table.CheckConstraint("ck_gljournal_posted_requires_postingdate", "(\"doc_status\" <> 'posted'::doc_status) OR (\"posting_date\" IS NOT NULL)");
                    table.CheckConstraint("ck_gljournal_posting_ge_journal", "\"posting_date\" IS NULL OR \"posting_date\" >= \"journal_date\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    gl_account_no = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_bankacct_currency_len3", "char_length(\"currency_code\") = 3");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_no = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'"),
                    created_by = table.Column<string>(type: "text", nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_glentry_one_sided_amount", "(\"debit\" >= 0) AND (\"credit\" >= 0) AND ((\"debit\" = 0 AND \"credit\" > 0) OR (\"credit\" = 0 AND \"debit\" > 0))");
                    table.CheckConstraint("ck_glentry_source_pairing", "(\"source_type\" IS NULL) OR (\"source_id\" IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    code = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    name = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    inventory_account = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    cogs_account = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    adjust_account = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    revenue_account = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'"),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'"),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    count_no = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    invoice_no = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    invoice_date = table.Column<DateOnly>(type: "date", nullable: false),
                    due_date = table.Column<DateOnly>(type: "date", nullable: false),
                    doc_status = table.Column<int>(type: "doc_status", nullable: false),
                    currency_code = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_apinvoice_currency_len3", "char_length(\"currency_code\") = 3");
                    table.CheckConstraint("ck_apinvoice_due_after_invoice", "\"due_date\" >= \"invoice_date\"");
                    table.CheckConstraint("ck_apinvoice_totals_nonnegative", "(\"tax_total\" >= 0) AND (\"doc_total\" >= 0)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    credit = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    description = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    signed_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false, computedColumnSql: "(\"debit\" - \"credit\")", stored: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_gjl_one_sided_amount", "(\"debit\" >= 0) AND (\"credit\" >= 0) AND ((\"debit\" = 0 AND \"credit\" > 0) OR (\"credit\" = 0 AND \"debit\" > 0))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_appayment_cleared_not_before_posting", "(\"cleared_date\" IS NULL) OR (\"posting_date\" IS NULL) OR (\"cleared_date\" >= \"posting_date\")");
                    table.CheckConstraint("ck_appayment_posted_requires_postingdate", "(\"doc_status\" <> 'posted'::doc_status) OR (\"posting_date\" IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_arreceipt_cleared_not_before_posting", "(\"cleared_date\" IS NULL) OR (\"posting_date\" IS NULL) OR (\"cleared_date\" >= \"posting_date\")");
                    table.CheckConstraint("ck_arreceipt_currency_len3", "char_length(\"currency_code\") = 3");
                    table.CheckConstraint("ck_arreceipt_fx_consistency", "(\"amount_foreign\" IS NULL OR \"exchange_rate\" IS NULL) OR abs((\"amount_foreign\" * \"exchange_rate\") - \"amount\") <= 0.01");
                    table.CheckConstraint("ck_arreceipt_fx_pair_nullness", "(\"amount_foreign\" IS NULL) = (\"exchange_rate\" IS NULL)");
                    table.CheckConstraint("ck_arreceipt_fx_positive", "(\"amount_foreign\" IS NULL OR \"amount_foreign\" > 0) AND (\"exchange_rate\" IS NULL OR \"exchange_rate\" > 0)");
                    table.CheckConstraint("ck_arreceipt_posted_requires_postingdate", "(\"doc_status\" <> 'posted'::doc_status) OR (\"posting_date\" IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_bankrec_range_valid", "\"statement_to\" >= \"statement_from\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_bankstmt_range_valid", "\"statement_to\" >= \"statement_from\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    dr_account_no = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    cr_account_no = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_banktxn_dr_neq_cr", "\"dr_account_no\" <> \"cr_account_no\"");
                    table.CheckConstraint("ck_banktxn_reconciled_requires_date", "(NOT \"is_reconciled\") OR (\"reconciled_date\" IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'"),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'"),
                    default_revenue_account_no = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    default_expense_account_no = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_apalloc_discount_nonneg", "\"discount_taken\" IS NULL OR \"discount_taken\" >= 0");
                    table.CheckConstraint("ck_apalloc_has_value", "(\"amount_applied\" > 0) OR (COALESCE(\"discount_taken\",0) > 0) OR (COALESCE(\"write_off_amount\",0) > 0)");
                    table.CheckConstraint("ck_apalloc_writeoff_nonneg", "\"write_off_amount\" IS NULL OR \"write_off_amount\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_aralloc_discount_nonneg", "\"discount_given\" IS NULL OR \"discount_given\" >= 0");
                    table.CheckConstraint("ck_aralloc_has_value", "(\"amount_applied\" > 0) OR (COALESCE(\"discount_given\", 0) > 0) OR (COALESCE(\"write_off_amount\", 0) > 0)");
                    table.CheckConstraint("ck_aralloc_writeoff_nonneg", "\"write_off_amount\" IS NULL OR \"write_off_amount\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    external_line_id = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    raw_code = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_bankstmtline_matchstatus_allowed", "\"match_status\" IN ('unmatched','proposed','matched','ignored')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    line_no = table.Column<int>(type: "integer", nullable: false),
                    description = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    account_no = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_apline_has_account_or_item", "(\"account_no\" IS NOT NULL) OR (\"item_id\" IS NOT NULL)");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_arline_has_item_or_revenue", "(\"item_id\" IS NOT NULL) OR (\"revenue_account\" IS NOT NULL)");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    location_id = table.Column<Guid>(type: "uuid", nullable: false),
                    transaction_type = table.Column<int>(type: "inventory_transaction_type", nullable: false),
                    qty = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    variance_qty = table.Column<decimal>(type: "numeric(18,4)", nullable: false, computedColumnSql: "\"counted_qty\" - \"expected_qty\"", stored: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
