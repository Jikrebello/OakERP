...
namespace OakERP.Infrastructure.Migrations
{
    ...
    [Migration("20260329151445_AddArInvoiceLineLocation")]
    partial class AddArInvoiceLineLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.ApInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.ApInvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.ApPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.ApPaymentAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.Vendor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.ArInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.ArInvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.ArReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.ArReceiptAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.FiscalPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.GlAccount", b =>
                {
                    b.Property<string>("AccountNo")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.GlEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.GlJournal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.GlJournalLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OakERP.Infrastructure.Persistence.Seeding.Views.AccountsPayable.APOpenItemView", b =>
                {
                    b.Property<decimal>("AmountApplied")
                        .HasColumnType("numeric")
                        .HasColumnName("amount_applied");
            ...
            modelBuilder.Entity("OakERP.Infrastructure.Persistence.Seeding.Views.AccountsReceivable.AROpenItemView", b =>
                {
                    b.Property<decimal>("AmountApplied")
                        .HasColumnType("numeric")
                        .HasColumnName("amount_applied");
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.ApInvoice", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.AccountsPayable.Vendor", "Vendor")
                        .WithMany("ApInvoices")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.ApInvoiceLine", b =>
                {
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "Account")
                        .WithMany("ApInvoiceLines")
                        .HasForeignKey("AccountNo")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_ap_invoice_lines_gl_accounts_account_no");

                    b.HasOne("OakERP.Domain.Entities.AccountsPayable.ApInvoice", "Invoice")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsPayable.ApPaymentAllocation", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.AccountsPayable.ApPayment", "Payment")
                        .WithMany("Allocations")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.ArInvoice", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.AccountsReceivable.Customer", "Customer")
                        .WithMany("ArInvoices")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.ArInvoiceLine", b =>
                {
                    b.HasOne("OakERP.Domain.Entities.AccountsReceivable.ArInvoice", "Invoice")
                        .WithMany("Lines")
                    ...
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "Revenue")
                        .WithMany("ArInvoiceLines")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.AccountsReceivable.ArReceiptAllocation", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.AccountsReceivable.ArReceipt", "Receipt")
                        .WithMany("Allocations")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.Bank.BankAccount", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "GlAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.Bank.BankTransaction", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "CrAccount")
                        .WithMany()
                    ...
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "DrAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.GlAccount", b =>
                {
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.GlEntry", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.FiscalPeriod", "Period")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.GeneralLedger.GlJournalLine", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlJournal", "Journal")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.Inventory.Item", b =>
                {
                    ...
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "DefaultExpenseAccount")
                        .WithMany()
                        .HasForeignKey("DefaultExpenseAccountNo")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_items_gl_accounts_default_expense_account_no");

                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "DefaultRevenueAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("OakERP.Domain.Entities.Inventory.ItemCategory", b =>
                {
                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "Adjust")
                        .WithMany()
                        .HasForeignKey("AdjustAccount")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_item_categories_gl_accounts_adjust_account");

                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "Cogs")
                        .WithMany()
                        .HasForeignKey("CogsAccount")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_item_categories_gl_accounts_cogs_account");

                    b.HasOne("OakERP.Domain.Entities.GeneralLedger.GlAccount", "InvAccount")
                        .WithMany()
